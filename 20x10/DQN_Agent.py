...
class DQN_Agent():
    def __init__(self,epsilon =0.9, gamma = 0.6,update_after_actions = 1,
                 epsilon_greedy_frames = 1000000, epsilon_random_frames =50000,
                 epsilon_min = 0.1, max_memory_length = 250000,
                 update_network = 5000, batch_size =32,num_actions=40):
